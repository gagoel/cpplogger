...
/**
 ...
 This file declares LoggerConf class. 
 LoggerConf handles all low level I/O operations from configuration file and 
...
#ifndef CPPUTILS_CPPLOGGER_CONF_H_
#define CPPUTILS_CPPLOGGER_CONF_H_
...
class LoggerConf
{
    ...
    private :
        ...
        static std::map<std::string, LogLevel>* groupname_loglevel_map;
        static bool SetLogLevelEnum(const std::string& in_group_name,
            LogLevel in_log_level);
	    static LogLevel GetLogLevelEnum(const std::string& in_group_name);
        static LogLevel ConvertLogLevelStringToEnum(
            const std::string& in_log_level);
        static LogLevel ConvertLogLevelIntToEnum(
            int in_log_level);
        static std::string ConvertLogLevelEnumToString(
            LogLevel in_log_level);
        static int ConvertLogLevelEnumToInt(
            LogLevel in_log_level);
        
        // Handlername libpath data strucutre and getter, setter methods.
        // This map is filled up by Init method at initialization time.
        static std::map<std::string, std::string>* handler_name_libpath_map;
        static bool SetHandler(const std::string& in_handler_name,
            const std::string& in_handler_libpath);
        static std::string GetHandler(const std::string& in_handler_name);
        ...
        static std::map<std::string, CheckProperty>* 
            property_name_validator_map;
        static bool SetPropertyValidator(const std::string& in_property_name,
            CheckProperty in_call_back_function);
        static CheckProperty GetPropertyValidator(
        ...
        // property_name_validator_map
        static std::map<std::string, std::string>* property_name_value_map;
        static bool IsValidPropertyName(const std::string& in_property_name); 
        ...
        static bool ParseLogConfigFile();
    ...
    public :
        ...
        static bool SetConfigFile(const std::string& in_log_file);
        ...
        static bool IsGroupNameExists(const std::string& in_group_name);
        ...
        static bool SetLogLevelString(const std::string& in_group_name,
            const std::string& in_log_level);
        ...
        // @return true/false log level string set successful or not.
        static bool SetLogLevelInt(const std::string& in_group_name,
            int in_log_level);
	    ...
	    static std::string GetLogLevelString(const std::string& in_group_name);
        ...
        static bool SetHandlerLibPath(const std::string& in_handler_name,
            const std::string& in_handler_libpath);
        ...
        static bool IsPropertyExists(const std::string& in_property_name); 
        ...
        // format
        static bool RegisterProperty(const std::string& property_name,
        ...
        // @param in_property_name property name string, can not be empty.
        static void UnRegisterProperty(const std::string& property_name);
        ...
        static bool SetPropertyValue(const std::string& in_property_name,
        ...
        static std::string GetPropertyValue(
            const std::string& in_property_name);
